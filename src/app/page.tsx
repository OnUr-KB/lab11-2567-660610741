...
export default function RegisterForm() {
  ...
  const agreeBtnOnChange = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <div className="mx-auto vstack gap-3" style={{ width: "400px" }}>
      ...
      <div>
        <input className="me-2" type="checkbox" onChange={agreeBtnOnChange} checked={isUserAgreed}/>I agree to the terms and
        conditions
      </div>
